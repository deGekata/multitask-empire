...
SRC_DIRS := src ecs signal player physics renderer logger geometry graphics/SFML spritesheet utility bot
...
-ggdb3 -std=c++20 -O3 -pthread -fsized-deallocation -Weverything\
