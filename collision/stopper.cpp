...
void CollisionStopperSystem::Configure(ecs::EntityManager& entities, ecs::EventManager& events) {
...
void CollisionStopperSystem::Recieve(const CollisionEvent& collided_pair) {
    ...
    auto box_first = first_entity.GetComponent<Collidable>();
    auto box_second = second_entity.GetComponent<Collidable>();
